...
pub struct McatConfig {
    ...
    #[arg(long = "image-protocol", hide = true,
        default_value_t = ImageProtocol::Auto,
        default_value_if("kitty", "true", "kitty"),
        default_value_if("iterm", "true", "iterm"),
        default_value_if("sixel", "true", "sixel"),
        default_value_if("ascii", "true", "ascii"))]
